...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Handle password update if provided - using same encryption as login system
    $password_update = '';
...
<head>
    ...
    <title>Edit Admin - CBE Doc's Store</title>
    ...
    <main class="main-content">
        ...
        <div class="form-container">
            <div class="form-header">
                <h2 class="form-title">Edit Admin Information</h2>
                <p class="form-subtitle">Update the details for <?php echo htmlspecialchars($admin['fullname']); ?></p>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data" id="adminForm">
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="fullname" class="form-input" value="<?php echo htmlspecialchars($admin['fullname']); ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-info">
                            <h4><i class="fas fa-image"></i> Current Profile Picture</h4>
                            <?php if (!empty($admin['profile_picture'])): ?>
                                <div class="preview-container">
                                    <div class="profile-preview">
                                        <img src="../uploads/profiles/<?php echo htmlspecialchars($admin['profile_picture']); ?>" alt="Current Profile Picture">
                                    </div>
                                </div>
                                <p>Upload a new image to replace the current one.</p>
                            <?php else: ?>
                                <p>No profile picture set. Upload an image to add one.</p>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="preview-container">
                            <div class="profile-preview" id="newImagePreview">
        ...
        profilePictureInput.addEventListener('change', function() {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    newImagePreview.innerHTML = `<img src="${e.target.result}" alt="New Profile Preview">`;
                }
